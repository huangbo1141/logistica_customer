...
@interface QuoteItemView : UIView<UITableViewDelegate,UITableViewDataSource>
...
@property (weak, nonatomic) IBOutlet UILabel *lblReserved;
...
@property (strong, nonatomic) QuoteModel* data;
